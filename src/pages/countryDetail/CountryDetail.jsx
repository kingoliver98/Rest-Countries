  ...
  useEffect(() => {
    const getACountry = async () => {
      try {
        ...
        setError("Ooops! Something went IoMdCodeWorking, Please Refresh.")
      }finally{
        setIsLoading(false);
      }
    };
    ...
    <div className="country-detail">
      <div className="container text-start py-5">
        <button
          ...
          className="px-5 py-3 border-0 mb-5 d-flex gap-2 align-items-center rounded-2 bg-elements custom-text-white shadow-lg"
        >
          <FaArrowLeftLong />
          Back
        </button>
